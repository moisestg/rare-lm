...
from vanilla_lm import VanillaLM
...
with tf.Graph().as_default():
	...
	with tf.variable_scope("model", reuse=None, initializer=initializer):
		model_train = VanillaLM(config=config, is_training=True, pretrained_emb=pretrained_emb)

	with tf.variable_scope("model", reuse=True, initializer=initializer):
		model_valid = VanillaLM(config=config, is_training=False, pretrained_emb=pretrained_emb)
